...
import base64
#https://heroku.com/deploy?template=https://github.com/charliecaplin/login.dev
...
def one(q):
    class BEAPI():
        def __init__(self):
            self.host = "https://api.coursehero.store"
            self.version = "1.5"
    ...
    if q == "ch@@":
        ...
        try:
            ...
            resultdict = {}
            #try:
                #sv = requests.get("https://api.coursehero.store/lineappname",timeout=7)
                #sv1 = sv.json()
            ...
            try:
                ...
                expiration = "60"
                qrcode = base64.b64encode(requests.get(qrcode, stream=True).content)
